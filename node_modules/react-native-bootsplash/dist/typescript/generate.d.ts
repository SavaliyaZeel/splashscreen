...
export declare const addFileToXcodeProject: (filePath: string) => void;
...
export declare const cleanIOSAssets: (dir: string, prefix: string) => void;
export declare const getIOSAssetFileName: ({ name, image, width, }: {
    name: string;
    image: Sharp;
    width: number;
}) => Promise<string>;
...
export declare const generate: ({ android, ios, platforms, html, flavor, licenseKey, ...args }: {
